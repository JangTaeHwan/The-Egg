...
public class Explain2 extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
	    ...
	    ImageView InitImage = (ImageView)findViewById(R.id.explain12);
	    Bitmap image = BitmapFactory.decodeResource(getResources(),R.drawable.ex2);
	    ...
	    InitImage.setOnTouchListener(new View.OnTouchListener() {
			...
			public boolean onTouch(View v, MotionEvent event) {
				Intent i = new Intent(Explain2.this,Explain3.class);
				startActivity(i);
				return false;
			}
		});
